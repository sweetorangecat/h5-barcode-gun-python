...
!function (t, e) {
    ...
    var C = "function" == typeof ArrayBuffer, B = function (t, e) {
        ...
        var n = t.charAt(0);
        return "b" === n ? {type: "message", data: S(t.substring(1), e)} : b[n] ? t.length > 1 ? {
            type: b[n],
            data: t.substring(1)
        } : {type: b[n]} : k
    }, S = function (t, e) {
    ...
    var q = setTimeout, I = clearTimeout;
    ...
    var tt = null != new Q({xdomain: !1}).responseType, et = function (t) {
        o(s, t);
        var n = p(s);
    ...
    var lt = function (n) {
        ...
        return r(a, [{
            ...
            key: "probe", value: function (t) {
                ...
                var i = function () {
                    r || (n.send([{type: "ping", data: "probe"}]), n.once("packet", (function (t) {
            ...
            key: "onOpen", value: function () {
                if (this.readyState = "open", a.priorWebsocketSuccess = "websocket" === this.transport.name, this.emitReserved("open"), this.flush(), "open" === this.readyState && this.opts.upgrade && this.transport.pause) for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t])
            }
        }, {
            key: "onPacket", value: function (t) {
    ...
    var pt = "function" == typeof ArrayBuffer, dt = Object.prototype.toString,
    ...
    function _t(e, n) {
        ...
        if (Array.isArray(e)) for (var r = 0; r < e.length; r++) e[r] = _t(e[r], n); else if ("object" === t(e)) for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (e[i] = _t(e[i], n));
        return e
    }
    ...
    var Ot = function () {
        ...
        return r(t, [{
            ...
            key: "encodeAsBinary", value: function (t) {
                var e = bt(t), n = this.encodeAsString(e.packet), r = e.buffers;
        ...
        return r(a, [{
            ...
            key: "decodeString", value: function (t) {
                var e = 0, n = {type: Number(t.charAt(0))};
            ...
            key: "isPayloadValid", value: function (e, n) {
                switch (e) {
                    case Et.CONNECT:
                        return "object" === t(n);
                    case Et.DISCONNECT:
    ...
    var Bt = Object.freeze({
        ...
        return r(i, [{
            ...
            key: "_registerAckCallback", value: function (t, e) {
                var n = this, r = this.flags.timeout;
                if (void 0 !== r) {
    ...
    function Pt(e, n) {
        ...
        }(e, (n = n || {}).path || "/socket.io"), o = i.source, s = i.id, a = i.path, c = Lt[s] && a in Lt[s].nsps;
